...
% prth = '.\result_test\gt\norain-001.png'
% mmm = imread(prth)
% path = 'C:\Users\lenovo\Desktop\290\statistic\result_test\gt\norain-001.png'
% mm = imread(path);

gt_path='../gt_align/';
% JORDER_path='../Rain100H_1254/rain_heavy_test/gt/';
% RESCAN_path='../results/Rain100H/Rain100H_RESCAN/';
% gt_path='C:\Users\lenovo\Desktop\290\statistic\result_test\gt\';
PReNet = '../epoch150/';
%%
% 
%  PREFORMATTED
...
%             x = (im2double(imread(fullfile(struct_model{nnn}.path,sprintf('rain-%03d_derain.png',iii)))));
            x = (im2double(imread(fullfile(struct_model{nnn}.path,sprintf('rain-%03d_derain.jpg',iii)))));
            x = rgb2ycbcr(x);x = x(:,:,1);
